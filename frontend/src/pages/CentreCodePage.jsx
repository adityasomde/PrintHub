...
export default function CentreCodePage({ centreCode, setCentreCode, handleCentreCode, centres, selectCentreAndUpload }) {
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <Card>
        ...
        <div className="mt-6 flex gap-3">
          ...
          />
          <button onClick={handleCentreCode} className="rounded-2xl bg-slate-900 px-5 py-3 text-white">
            <Search size={20} />
          </button>
        </div>
